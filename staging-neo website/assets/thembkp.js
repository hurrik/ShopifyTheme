  ...
  var ProductVariants = function () {
    ...
    _createClass(ProductVariants, [{
      ...
      value: function _updateEdp(newVariant, previousVariant) {
        var productEdp = this.element.querySelector('.product-meta__edp-number');
        var currentEdp = newVariant;
        ...
        if (!newVariant) {
          productEdp.style.display = 'none';
        } else {
          if (previousVariant && previousVariant['sku'] === newVariant['sku']) {
            return; // The SKU do not have changed so let's return to avoid changing the DOM for nothing
          }

          productEdp.innerHTML = currentEdp;
          productEdp.style.display = '';
        }
      }
    ...
    _createClass(ProductRecommendationsSection, [{
      ...
      value: function _createSlideshow() {
        ...
        var toSort = this.element.querySelector('.product-list').children;
          ...
          console.log(this.flickityInstance);

  ...
  var ProductVariants = function () {
    function ProductVariants(element, options) {
      ...
      if (productJsonElement) {
        ...
        this.productMetadate = jsonData['metadata'];
        ...
        this._updateProductPrices(newVariant, previousVariant);
          ...
          if(ChargeAfter){
            ChargeAfter.promotionalWidget.update({
              items: [{sku: newVariant.sku,price: (newVariant.price/100)}]
            });
          }
...
//         console.log(newVariant,previousVariant)
        ...
        // 3th: update EDP by Ryhan Ramos
        this._updateEdp(newVariant, previousVariant);
      ...
      key: '_updateEdp',
      value: function _updateEdp(newVariant, previousVariant) {
         this.element.querySelector(".product-meta__edp-number").style.display = 'none'
         ...
         if (!newVariant) {
           ...
           var productEdp = this.element.querySelector('#edp-'+newVariant.id);
           productEdp.style.display = 'block';
         }
...
//       }
    ...
    _createClass(ProductRecommendationsSection, [{
      ...
      value: function _createSlideshow() {
        ...
        var toSort = this.element.querySelector('.product-list').children;
            toSort = Array.prototype.slice.call(toSort, 0);

            toSort.sort(function(a, b) {
              var aord = +a.getAttribute('data-qh-cost');
              var bord = +b.getAttribute('data-qh-cost');
              return (aord > bord) ? 1 : -1;
            });

            var parent = this.element.querySelector('.product-list');
            parent.innerHTML = "";
          ...
          window.recommendationflickity = this.flickityInstance;
        }
